...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/postiz-agent"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in postiz-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in postiz-agent but are NOT registered "
