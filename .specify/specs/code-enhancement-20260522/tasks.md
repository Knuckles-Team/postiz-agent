...
Generated: 2026-05-22T22:12:33.137346+00:00
...
- [ ] [P] **T010** [Architecture & Design Patterns] No discernible layer architecture (no domain/service/adapter separation)
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T011** [Architecture & Design Patterns] Low dependency injection ratio: 7%
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T012** [Concept Traceability] Low traceability ratio: 0% concepts fully traced
  - Priority: P4-Enhancement | Effort: Medium
- [ ] [P] **T013** [Concept Traceability] 20 test functions missing concept markers
  - Priority: P4-Enhancement | Effort: Small
...
- [ ] [P] **T021** [Pytest Quality] Missing conftest.py for shared fixtures
  - Priority: P2-Medium | Effort: Small
- [ ] [P] **T022** [Pytest Quality] Low fixture usage: only 0% of tests use fixtures
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T023** [Pytest Quality] No @pytest.mark.parametrize usage — consider data-driven tests
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T024** [Pytest Quality] No shared fixtures in conftest.py
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T025** [Pytest Quality] 2 tests have no assertions
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T026** [Pytest Quality] 2 tests exceed 100 lines — likely doing too much per test
  - Priority: P2-Medium | Effort: Medium
- [ ] [P] **T027** [Environment Variables] Partial env var documentation: 32% coverage
  - Priority: P2-Medium | Effort: Medium
